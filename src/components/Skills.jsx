...
const Skills = () => {
    ...
    let playcode = ["/* Contact me let's talk */", "var", "object", "=", "{", "name", ":", "'Zedekiah'",",", "age", ":", "23,", "gender", ":", "'male',", "location", ":", "'Kenya',", "skills", ":", "[", "'Javascript',", "'HTML',", "'CSS',", "'Python',", "'C#',", "'React.js',", "'Django']", "};", "var", "happy", "=", "'Check", "out", "my", "works';", "Console",".","log","(","happy",")",";"];
